...
2. Заява на ім'я директора. ``Заява макет.docx``github.com/olehgbr/Flipper-Zero-sbu/blob/master/assets/%D0%97%D0%B0%D1%8F%D0%B2%D0%B0%20%D0%BC%D0%B0%D0%BA%D0%B5%D1%82.docx
   Заповнюємо червоні вставки своїми даними
3. Товаро супровідні документи (інвойс  та товарна накладна та квитанції, яку ви отримуєте після оплати банкіською картою на сайті).
4. Всі необхідні документи додав в **папку assets**
...
https://github.com/olehgbr/Flipper-Zero-sbu/blob/master/assets/Flipper%20Zero%20Документація%20ukr.pdf
...
Для того щоб замовити Висновок ІСТЕ СБУ для митного оформлення, отримувачу необхідно надати: Заяву на ім'я директора де указано № інвойса та товарна накладна від Flipper Zero,
...
який ,який був створений тим самим СБУ та діє при СБУ. 
   ...
   Я замовлял через  компанію USAIN.UA, яка мені надала адрессу свого складу в США  та яким  Я надіслав гроші через їхній додатока USAIN.UА та  замовив Flipper Zero с сайта **shop.flipperzero.one** на їхній склад в США.
...
🔗 Прикріплюємо до листа всі документи з 1го пункту з  **папки assign**, обов'язково підписати за допомогою ЕЦП, та всі файли підпису для контрольної перевірки.

Також додаємо до листа всі файли з **папки assign**, _підписувати не треба_
...
![donation](https://github.com/olehgbr/Flipper-Zero-sbu/assets/146317058/d5e765f5-b827-41f3-9e3f-d0d97cbf9f77)
 ...
 🔗Посилання на банку🔗  [https://send.monobank.ua/jar/9BbZhAQyE4]
                                                        ...
                                                        **Зустрічайте мій пристрій Flipper Zero**
                                                        
який Я забрав у СБУ так як надав **висновок ІСТЕ, що даний пристрій не відноситься до спеціальних технічних засобів Негласного отримання інформації**** 
