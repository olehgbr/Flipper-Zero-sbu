...
так як надав **висновок ІСТЕ, що даний пристрій не відноситься до спеціальних технічних засобів Негласного отримання інформа
...
**Контакти:*Тел./факс: +38 (044) 408-45-88 +38 (044) 422-77-77
...
**4.** Технічний опис та технічна (експлуатаційна) документацію на заяленний товар та ії переклад, що дозволять ідентифікувати товар за призначенням.
...
![documents](https://github.com/olehgbr/Flipper-Zero-sbu/assets/146317058/f531e0ff-bf46-4844-9f9d-5e2498229698)
...
+ також науково-дослідний інститут налякало мене те що пристрій був вилучений працівниками СБУ.
...
🔗 Прикріплюємо до листа необхідні документи **папки assets**  обов'язково підписаними за допомогою ЕЦП, та всі файли підпису для контрольної перевірки.
...
**Якщо вам необідно домога з документами для митного оформлення, а також з Висновоком ІСТЕ СБУ (Висновоком для проведення митного оформленням), технічний описом, товаросупровідними документами та ІНВОЙСОМ**

**або у Вас вилучили Flipper Zero працівники СБУ, коли Ви намагалися його продати через olx.ua та Вам необхідні підтвердуючі документи для того, щоб СБУ не могло завести, як кримінальні, так і адміністративні правопорушення пишіть мені в телеграм 
t.me/ol3eh або телефонуйте 096-154-78-57**
...
![donation](https://github.com/olehgbr/Flipper-Zero-sbu/assets/146317058/642c0e21-cea6-4913-b5ba-d58f50dbefe0)

                                                              
![Happy_Relicana](https://github.com/olehgbr/Flipper-Zero-sbu/assets/146317058/a5217f0d-13d7-4850-b188-fa4c8be5bea6)
